...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "The given address must not be the owner of the tokenId");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == getOwner(), "msg sender must be the owner of contract");
        require(isApprovedForAll(msg.sender, to), "operator must be approved by a given owner");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == _tokenOwner[tokenId], "from address must be token owner");

        // TODO: require token is being transfered to valid address
        require(to != address(0), "to address must be valid address");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint256 tokenId) internal {
        require(_exists(tokenId), "Token for tokenId must exists");
...
contract CustomERC721Token is ERC721Metadata {
    ...
    constructor() public ERC721Metadata("Realestate Token", "RET", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
